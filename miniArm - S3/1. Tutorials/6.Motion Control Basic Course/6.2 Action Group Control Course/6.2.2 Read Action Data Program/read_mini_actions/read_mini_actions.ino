...
static uint8_t knob_angles[5] = { 90, 90, 90, 90, 90};   /* 旋钮产生的角度数值(the angle values generated by the knobs) */
static float servo_angles[5] = { 90, 90, 90, 90, 90};  /* 舵机实际控制的角度数值(the acual angle values for servo contorl) */
